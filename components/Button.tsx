...
export const Button = ({
  ...
  const styles = {
    ...
    primary:
      ...
      " dark:bg-primary-dark-500 dark:hover:bg-primary-500 dark:active:bg-primary-600 dark:border-primary-dark-500 dark:hover:border-primary-500 dark:active:border-primary-600 dark:focus-visible:border-primary-600 ",
    secondary:
  ...
  return (
    <button
      className={cn(
        ...
        styles.text,
        variant == "secondary" && "dark:text-surface-primary"
      )}
      {...props}
    >
